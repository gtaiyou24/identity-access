...
from domain.model.user import EmailAddress, EncryptionService
...
class User:
    ...
    def __init__(self, email_address: EmailAddress, encrypted_password, enable: bool):
    ...
    @staticmethod
    def new(email_address: EmailAddress, plain_password: str) -> User:
        return User(
            email_address,
